...
In a short passage Holmes reflects on if the method of using punch cards to program a weaving machine could lead to machines that could do even harder things, maybe even deductions. A theme that is explored in another book, [The thinking engine](https://sherlock.kristoferhallen.com/post/thethinkingengine/).